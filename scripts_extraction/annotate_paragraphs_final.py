...
with open("paragraphs_final.csv", "r", encoding="utf-8") as f1:
    paragraphs = csv.DictReader(f1)
    paragraphs = list(paragraphs)
f1.close()

with open("places_final.csv", "r", encoding="utf-8") as f3:
    places = csv.DictReader(f3)
    places = list(places)
f3.close()

with open("people_final.csv", "r", encoding="utf-8") as f3:
    people = csv.DictReader(f3)
    people = list(people)
f3.close()

with open("works_final.csv", "r", encoding="utf-8") as f3:
...
with open("annotations_final.csv", "w", encoding="utf-8") as f:
...
keys = annotations[0].keys()
with open("annotations_no_work_final.csv", "w", encoding="utf-8") as f:
    dict_writer = csv.DictWriter(f, keys)
    dict_writer.writeheader()
